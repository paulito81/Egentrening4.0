INSERT INTO User (id, email, password, worktype) VALUES (1, 'mari@test.com', '123AeBc#!', 'STUDENT');
INSERT INTO User (id, email, password, worktype) VALUES (2, 'ole@test.com', 'abCD123#!', 'TEACHER');
...
INSERT INTO User (id, email, password, worktype) VALUES (5, 'geir@test.com', '12v34Abc#!', 'STUDENT');
INSERT INTO User (id, email, password, worktype) VALUES (6, 'TEST@yahoo.no', 'TeSTe#!2133', 'STUDENT');
...
INSERT INTO SUBJECT (id, name, FK_LOCATION) VALUES (6, 'testRoom', 5);
